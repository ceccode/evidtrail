...
- 2de9129: AIDA Metrics is now **evidtrail**. Same tool, same numbers, one name that survives a search.
...
- Updated dependencies [2de9129]
  - @evidtrail/core@1.1.0
  - @evidtrail/metrics@1.1.0
